...
const Chat = {
    ...
    _addRemediationCards(findings) {
        ...
        const actionConfig = {
            ...
            'All traffic inbound': { icon: '🔒', label: 'Restrict SG', color: '#7c4dff' },
            'Public S3': { icon: '📦', label: 'Block Public', color: '#7c4dff' },
            'Old access key': { icon: '🔑', label: 'Deactivate Key', color: '#7c4dff' },
            'IMDSv1': { icon: '🛡️', label: 'Enforce IMDSv2', color: '#7c4dff' },
            'GuardDuty not': { icon: '🕵️', label: 'Enable GuardDuty', color: '#00b4ff' },
            'CloudTrail logging stopped': { icon: '📝', label: 'Start Logging', color: '#00b4ff' },
            ...
            'S3 bucket not encrypted': { icon: '🔐', label: 'Encrypt', color: '#7c4dff' },
            'S3 versioning disabled': { icon: '📋', label: 'Enable Versioning', color: '#00b4ff' },
            'S3 access logging': { icon: '📊', label: 'Enable Logging', color: '#00b4ff' },
            'RDS not encrypted': { icon: '🔐', label: 'View Steps', color: '#ff9100' },
            'No rotation configured': { icon: '🔄', label: 'Setup Rotation', color: '#ff9100' },
            'Secret never accessed': { icon: '🗑️', label: 'Delete Secret', color: '#ff5252' },
            'ECR scan disabled': { icon: '🔍', label: 'Enable Scan', color: '#00b4ff' },
            'No EKS logging': { icon: '📝', label: 'Enable Logging', color: '#00b4ff' },
            'Partial EKS logging': { icon: '📝', label: 'Enable All Logs', color: '#00b4ff' },
            'EKS secrets not': { icon: '🔐', label: 'Encrypt Secrets', color: '#7c4dff' },
            'DynamoDB PITR': { icon: '⏱️', label: 'Enable PITR', color: '#00b4ff' },
            'RDS backup retention': { icon: '💾', label: 'Increase Retention', color: '#00b4ff' },
            'Very stale snapshot': { icon: '🗑️', label: 'Delete Snapshot', color: '#ff5252' },
            'Unused security group': { icon: '🗑️', label: 'Delete SG', color: '#ff5252' },
            'VPC DNS hostnames': { icon: '🌐', label: 'Enable DNS', color: '#00b4ff' },
            'Unused VPC endpoint': { icon: '🗑️', label: 'Delete Endpoint', color: '#ff5252' },
            'Stopped EC2': { icon: '💀', label: 'Terminate', color: '#ff5252' },
        };
